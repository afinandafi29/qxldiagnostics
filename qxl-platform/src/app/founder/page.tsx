...
export default function FounderPage() {
  const founder = {
    ...
    image: "/image/dr_shantakumar.png",
  ...
  const advisors = [
    ...
    },
    {
      ...
      image: "/image/advisor_jagadeesha.png",
    ...
    <div className="bg-[#f8faff] min-h-screen">
      ...
      <section className="py-14 bg-[#f8faff] border-t border-gray-100">
        <div className="max-w-[1260px] mx-auto px-4 w-full">
          <div className="flex items-center gap-3 mb-8">
            <Users className="w-5 h-5 text-[#2563eb]" />
            <h2 className="text-xl md:text-2xl font-extrabold text-[#0f2d5e] uppercase tracking-wider">Qualified Staff at Bengaluru Lab</h2>
          </div>
          <div className="bg-white border border-gray-150 rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col">
            <div className="w-full h-[500px] bg-[#dbeafe] overflow-hidden">
              <img src="/image/qualified_staff.png" alt="Qualified Staff at Bengaluru Lab"
                className="w-full h-full object-cover object-center"
                onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=600&auto=format&fit=crop"; }} />
            </div>
          </div>
        </div>
      </section>
