...
import { ChevronRight, CheckCircle, Bone, Stethoscope, Microscope, Activity } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-blue-100 text-lg md:text-xl mb-8 leading-relaxed">
              Bone disorders encompass a variety of conditions that affect the strength, structure, and function of bones. Proper diagnosis and monitoring are essential for managing these conditions effectively.
            </p>
