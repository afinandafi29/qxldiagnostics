  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="bg-gradient-to-r from-sky-600 to-sky-800 text-white py-16 lg:py-24 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10 bg-[url('https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=2000')] bg-cover bg-center"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Gastroenterology</h1>
            <p className="text-sky-100 text-lg md:text-xl mb-8 leading-relaxed">
              Liver function panels, pancreatic health markers, and digestive disorder diagnostics.
            </p>
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center text-sm text-gray-500">
          ...
          <ChevronRight className="w-4 h-4 mx-2" />
          <span className="text-black font-medium">Gastroenterology</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="prose prose-blue max-w-none">
              <p className="text-gray-700 text-lg leading-relaxed">
                Assess your digestive tract health, liver enzymes, and pancreatic function with our specialized diagnostic assays.
              </p>
            </section>
            ...
            <section id="test-profiles">
              <h2 className="text-3xl font-bold text-black mb-6 flex items-center gap-3">
                ...
                Gastroenterology Test Profiles
              </h2>
              <div className="grid gap-6">
                  ...
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Liver Function Test (LFT) - Advanced</h3>
                      <p className="text-gray-600 text-sm mb-4">Bilirubin (Total, Direct, Indirect), SGOT (AST), SGPT (ALT), Alkaline Phosphatase, GGTP, Total Protein, Albumin, Globulin, A/G Ratio.</p>
                    </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-sky-500 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Pancreatic Wellness Panel</h3>
                      <p className="text-gray-600 text-sm mb-4">Serum Amylase, Serum Lipase.</p>
                    </div>
                    <Link href="/book" className="bg-sky-600 text-white font-medium px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-700 transition-colors">
                      Request Latest Price
                    </Link>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-sky-500 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Celiac Disease Screening</h3>
                      <p className="text-gray-600 text-sm mb-4">Anti-Tissue Transglutaminase (tTG) IgA, Total IgA, Anti-Deamidated Gliadin Peptide (DGP) IgG.</p>
                    </div>
                    <Link href="/book" className="bg-sky-600 text-white font-medium px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-700 transition-colors">
                      Request Latest Price
                    </Link>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-sky-500 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">H. Pylori (Gastro-Duodenal) Screen</h3>
                      <p className="text-gray-600 text-sm mb-4">H. Pylori Antigen in Stool, H. Pylori IgG Antibody.</p>
                    </div>
                    <Link href="/book" className="bg-sky-600 text-white font-medium px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-700 transition-colors">
                      Request Latest Price
                    </Link>
            ...
            <section>
              ...
              <div className="space-y-4">
                  ...
                  <h4 className="font-bold text-black mb-2">1. What does an elevated ALT or AST level mean?</h4>
                  <p className="text-gray-600 text-sm">Elevated liver enzymes (SGOT/SGPT) can indicate liver inflammation or cell injury, which may be caused by fatty liver, medications, alcohol, or viral hepatitis.</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-xl p-5">
                  <h4 className="font-bold text-black mb-2">2. Do I need to fast for a Liver Function Test?</h4>
                  <p className="text-gray-600 text-sm">Yes, a fasting period of 10-12 hours is recommended before an LFT to ensure accurate lipid and bilirubin readings.</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-xl p-5">
                  <h4 className="font-bold text-black mb-2">3. How is celiac disease diagnosed through blood?</h4>
                  <p className="text-gray-600 text-sm">By testing for specific antibodies (like Anti-tTG IgA) that are elevated when someone with celiac disease consumes gluten, causing autoimmune gut lining damage.</p>
                </div>
              </div>
            </section>
