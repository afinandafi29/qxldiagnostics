  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="bg-gradient-to-r from-sky-600 to-sky-800 text-white py-16 lg:py-24 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10 bg-[url('https://images.unsplash.com/photo-1579156492187-c374b2739e91?q=80&w=2000')] bg-cover bg-center"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-sky-100 text-lg md:text-xl mb-8 leading-relaxed">
              Tumor marker screenings and advanced diagnostic assays for cancer risk evaluation and monitoring.
            </p>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="prose prose-blue max-w-none">
              <p className="text-gray-700 text-lg leading-relaxed">
                We offer specialized tumor marker profiles to aid in screening, treatment monitoring, and post-therapy surveillance for various malignancies.
              </p>
            </section>
            ...
            <section id="test-profiles">
              ...
              <div className="grid gap-6">
                  ...
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Male Tumor Marker Panel</h3>
                      <p className="text-gray-600 text-sm mb-4">PSA (Prostate), CEA (Colon/Lungs), AFP (Liver/Testes), CA 19-9 (Pancreas/Biliary).</p>
                    </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-sky-500 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Female Tumor Marker Panel</h3>
                      <p className="text-gray-600 text-sm mb-4">CA 125 (Ovarian), CA 15-3 (Breast), CEA (Colon/Lungs), AFP (Liver/Germ Cell), CA 19-9.</p>
                    </div>
                    <Link href="/book" className="bg-sky-600 text-white font-medium px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-700 transition-colors">
                      Request Latest Price
                    </Link>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-sky-500 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Gastrointestinal Oncology Panel</h3>
                      <p className="text-gray-600 text-sm mb-4">CEA, CA 19-9, CA 72-4, AFP.</p>
                    </div>
                    <Link href="/book" className="bg-sky-600 text-white font-medium px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-700 transition-colors">
                      Request Latest Price
                    </Link>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-sky-500 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Ovarian Cancer Screen (ROMA Index)</h3>
                      <p className="text-gray-600 text-sm mb-4">HE4, CA 125, Risk of Ovarian Malignancy Algorithm calculation.</p>
                    </div>
                    <Link href="/book" className="bg-sky-600 text-white font-medium px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-700 transition-colors">
                      Request Latest Price
                    </Link>
            ...
            <section>
              ...
              <div className="space-y-4">
                  ...
                  <h4 className="font-bold text-black mb-2">1. What are tumor markers?</h4>
                  <p className="text-gray-600 text-sm">These are substances (usually proteins) produced by cancer cells or by the body in response to cancer. They can be measured in blood or urine.</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-xl p-5">
                  <h4 className="font-bold text-black mb-2">2. Can a tumor marker test diagnose cancer on its own?</h4>
                  <p className="text-gray-600 text-sm">No, tumor markers are not definitive diagnostic tools on their own. They are used in combination with biopsies, imaging, and clinical symptoms to form a diagnosis.</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-xl p-5">
                  <h4 className="font-bold text-black mb-2">3. How are tumor markers used during cancer treatment?</h4>
                  <p className="text-gray-600 text-sm">Doctors track tumor marker levels over time. A decrease in levels often indicates that the treatment is effective, while an increase may suggest recurrence.</p>
                </div>
              </div>
            </section>
