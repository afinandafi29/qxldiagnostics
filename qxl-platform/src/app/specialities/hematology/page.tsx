...
export default function HematologyPage() {
  const IconComponent = iconMap["Droplet"] || Activity;

  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Hero Banner */}
      <section className="bg-gradient-to-r from-sky-600 to-sky-800 text-white py-16 lg:py-24 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10 bg-[url('https://images.unsplash.com/photo-1582719508461-905c673771fd?q=80&w=2000')] bg-cover bg-center"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Hematology</h1>
            <p className="text-sky-100 text-lg md:text-xl mb-8 leading-relaxed">
              Comprehensive blood and bone marrow diagnostics for anemia, coagulation disorders, and leukemia.
            </p>
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center text-sm text-gray-500">
          ...
          <ChevronRight className="w-4 h-4 mx-2" />
          <span className="text-black font-medium">Hematology</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="prose prose-blue max-w-none">
              <p className="text-gray-700 text-lg leading-relaxed">
                Our advanced hematology panels assess blood cell counts, hemoglobin variants, and coagulation factors to diagnose and monitor blood-related conditions.
              </p>
            </section>
            ...
            <section id="test-profiles">
              ...
              <div className="grid gap-6">
                  ...
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Anemia Profile - Extended</h3>
                      <p className="text-gray-600 text-sm mb-4">Complete Blood Count (CBC), Iron Studies, Ferritin, Transferrin, Vitamin B12, Folate, Erythropoietin.</p>
                    </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-sky-500 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Coagulation Profile</h3>
                      <p className="text-gray-600 text-sm mb-4">Prothrombin Time (PT/INR), Activated Partial Thromboplastin Time (APTT), Fibrinogen, D-Dimer.</p>
                    </div>
                    <Link href="/book" className="bg-sky-600 text-white font-medium px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-700 transition-colors">
                      Request Latest Price
                    </Link>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-sky-500 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Thalassemia & Hemoglobinopathy Screening</h3>
                      <p className="text-gray-600 text-sm mb-4">Hb HPLC, CBC, Peripheral Smear review, Reticulocyte count.</p>
                    </div>
                    <Link href="/book" className="bg-sky-600 text-white font-medium px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-700 transition-colors">
                      Request Latest Price
                    </Link>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-sky-500 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start gap-4 flex-col md:flex-row">
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Bleeding Disorders Panel</h3>
                      <p className="text-gray-600 text-sm mb-4">Bleeding Time, Clotting Time, Platelet Aggregation, Factor VIII & IX Assay.</p>
                    </div>
                    <Link href="/book" className="bg-sky-600 text-white font-medium px-4 py-2 rounded-lg whitespace-nowrap hover:bg-sky-700 transition-colors">
                      Request Latest Price
                    </Link>
            ...
            <section>
              ...
              <div className="space-y-4">
                  ...
                  <h4 className="font-bold text-black mb-2">1. What does a hematology test diagnose?</h4>
                  <p className="text-gray-600 text-sm">Hematology tests help diagnose conditions like iron-deficiency anemia, vitamin deficiencies, bleeding/clotting disorders, thalassemia, leukemia, and platelet disorders.</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-xl p-5">
                  <h4 className="font-bold text-black mb-2">2. Do I need to fast for hematology blood tests?</h4>
                  <p className="text-gray-600 text-sm">Standard CBC and coagulation profiles do not require fasting. However, if you are getting an Anemia Profile that includes Iron Studies, an 8-12 hour fast is highly recommended.</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-xl p-5">
                  <h4 className="font-bold text-black mb-2">3. What is Hb HPLC?</h4>
                  <p className="text-gray-600 text-sm">High-Performance Liquid Chromatography (HPLC) is a precise test used to screen for abnormal hemoglobin types, essential for diagnosing thalassemia and sickle cell traits.</p>
                </div>
              </div>
            </section>
